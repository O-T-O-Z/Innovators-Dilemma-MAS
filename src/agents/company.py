...
class CompanyAgent(Agent):
    ...
    def innovate(self, innovation_factor):
        innovation_cost = self.budget * innovation_factor
        self.capital -= innovation_cost

    def exploit(self, exploitation_factor):
        self.product.improve(exploitation_factor)
        exploitation_cost = self.budget * exploitation_factor
